...
struct reference_predictor_table {
...
struct delta_correlating_prediction_table {
	md_addr_t tag;
	md_addr_t prev_addr;
...
struct cache_t
{
  ...
  struct reference_predictor_table *rpt;
  struct delta_correlating_prediction_table *dcpt;
